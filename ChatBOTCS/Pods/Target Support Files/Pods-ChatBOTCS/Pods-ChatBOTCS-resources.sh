...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_resource "${PODS_ROOT}/ApiAI/ApiAI/UIKit/Images/AICubeIconImage.png"
  install_resource "${PODS_ROOT}/ApiAI/ApiAI/UIKit/Images/AICubeIconImage@2x.png"
  install_resource "${PODS_ROOT}/ApiAI/ApiAI/UIKit/Images/AICubeIconImage@3x.png"
  install_resource "${PODS_ROOT}/ApiAI/ApiAI/UIKit/Images/AIMicrophoneControlImage.png"
  install_resource "${PODS_ROOT}/ApiAI/ApiAI/UIKit/Images/AIMicrophoneControlImage@2x.png"
  install_resource "${PODS_ROOT}/ApiAI/ApiAI/UIKit/Images/AIMicrophoneControlImage@3x.png"
  install_resource "${PODS_ROOT}/ApiAI/ApiAI/UIKit/Classes/AIVoiceRequestButton.xib"
  install_resource "${PODS_ROOT}/ApiAI/ApiAI/VoiceRequest/Resources/beep.caf"
